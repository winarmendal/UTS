    ...
    public static void main(String[] args) throws Exception {
        ...
        int jum_karyawan = Input1.nextInt();
         ...
         for(int i = 1; i <= jum_karyawan; ++i){
            ...
            if(golongan == 1){
                float tun_golongan = (float) (0.05*3000000);
             }else if(golongan == 2){
                float tun_golongan = (float) (0.1*3000000);
             }else if(golongan == 3){
                float tun_golongan = (float) (0.15*3000000);
             }else{
             ...
             if(pendidikan == 1){
                float tun_pendidikan = (float) (0.025*3000000);
             }else if(pendidikan == 2){
                float tun_pendidikan = (float) (0.05*3000000);
             }else if(pendidikan == 3){
                float tun_pendidikan = (float) (0.075*3000000);
             }
             ...
             //menghitung honor lembur
                if(jam_kerja > 8){
                    ...
                    float total_honor_lembur = honorPerJam*tun_lembur;
            ...
            System.out.println("                          ----------------------------  +");
            System.out.println("Honor yang Diterima        Rp." + (3000000 + tun_golongan + tun_pendidikan + total_honor_lembur));
            System.out.println("===============================================================");
         }
